    ...
    <div className="faqContainer" id="faqContainer">
      ...
      <div className="accordion">
        ...
        <Accordion title="HOW MUCH DO CLUCKY CHICKS COST?" index={1} selectedIndex={selectedIndex} setSelectedIndex={setSelectedIndex}>
            <p>The OG collection of Clucky Chicks are launching at only 0.05 ETH. Once they hit secondary market however, it's anyone's guess, as we don't control that.</p>
        </Accordion>
        ...
        <Accordion title="WHERE CAN WE TALK TO YOU?" index={3} selectedIndex={selectedIndex} setSelectedIndex={setSelectedIndex}>
            <p>You can either tweet me at <a href='https://twitter.com/CluckyChicksNFT'>@CluckyChicksNFT</a> on Twitter. Or preferably join our Discord at <a href='https://discord.gg/7d8tkcu7QM'>https://cluckychicks.app/discord</a> for a chat! <br /> 
